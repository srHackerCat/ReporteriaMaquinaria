...
{
    public partial class VisorFacturacionXRubro : System.Web.UI.Page
    {
        ...
        private void cargarInformacion()
        {
            ...
            string rutareporte = Server.MapPath(@"Reportes\ReportesR2Servicios\RPT_FACTURACION_POR_RUBRO.rpt");
            ...
            reportDocument.SetParameterValue("@FECHA_INICIAL", pValue);
            ...
            reportDocument.SetParameterValue("@FECHA_FINAL", pValue2);

            ParameterValues pValue3 = new ParameterValues();
            ParameterDiscreteValue pDiscreteValue3 = new ParameterDiscreteValue();

            pDiscreteValue3.Value = Request.QueryString["psCompania"];
            pValue3.Add(pDiscreteValue3);
            reportDocument.SetParameterValue("@ID_COMPANIA", pValue3);
        ...
        public string pdfcontroller(ReportDocument rpd)
        {
            ...
            {
                string filepath = "";
                string fileName = "RPT_FACTURACION_POR_RUBRO" + Request.QueryString["psFechaIni"] + Request.QueryString["psFechaFin"] + Request.QueryString["psCompania"];
