...
{
    public partial class VisorHorometrosMaquinas : System.Web.UI.Page
    {
        ...
        private void cargarInformacion()
        {
            ...
            string rutareporte = Server.MapPath(@"Reportes\ReporteR2Maquinaria\RPT_HOROMETROS_DE_MAQUINARIA.rpt");
        ...
        public string pdfcontroller(ReportDocument rpd)
        {
            ...
            {
                string filepath = "";
                string fileName = "RPT_HOROMETRO_MAQUINAS" +Request.QueryString ["psFechaIni"]+Request.QueryString["psFechaFin"];
